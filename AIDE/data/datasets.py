...
class TestDataset(Dataset):
    def __init__(self, is_train, args):
        ...
        self.dct = DCT_base_Rec_Module()
        self.dct16 = DCT_base_Rec_Module(window_size=16)
        # self.dct64 = DCT_base_Rec_Module(window_size=64)
    ...
    def __getitem__(self, index):
        ...
        x_minmin16, x_maxmax16, x_minmin1_16, x_maxmax1_16 = self.dct16(image)

        # x_minmin64, x_maxmax64, x_minmin1_64, x_maxmax1_64 = self.dct64(image)

        x_minmin16 = transform_train(x_minmin16)
        x_maxmax16 = transform_train(x_maxmax16)
        x_minmin1_16 = transform_train(x_minmin1_16)
        x_maxmax1_16 = transform_train(x_maxmax1_16)

        # x_minmin64 = transform_train(x_minmin64)
        # x_maxmax64 = transform_train(x_maxmax64)
        # x_minmin1_64 = transform_train(x_minmin1_64)
        # x_maxmax1_64 = transform_train(x_maxmax1_64)
        ...
        # patches_list = [x_minmin, x_maxmax, x_minmin1, x_maxmax1, x_minmin16, x_maxmax16, x_minmin1_16, x_maxmax1_16, x_minmin64, x_maxmax64, x_minmin1_64, x_maxmax1_64, x_0]

        patches_list = [x_minmin, x_maxmax, x_minmin1, x_maxmax1, x_minmin16, x_maxmax16, x_minmin1_16, x_maxmax1_16, x_0]

        # patches_list = [x_minmin, x_maxmax, x_minmin1, x_maxmax1, x_minmin64, x_maxmax64, x_minmin1_64, x_maxmax1_64, x_0]
        
        return torch.stack(patches_list, dim=0), torch.tensor(int(targets)), image_path
        # return torch.stack([x_minmin, x_maxmax, x_minmin1, x_maxmax1, x_0], dim=0), torch.tensor(int(targets))
